...
public:
    ...
    /*Others*/
    User registerUser(const std::string &username, const string fullName, const string password, const int phoneNumber, idType, idNumber, driverLicense, expiryDate, creditPoints, renterRatingScore);
