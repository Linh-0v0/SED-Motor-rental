...
public:
    ...
    /*Others*/
    User registerUser(const std::string &username, const string fullName, const string password, const int phoneNumber, const int idType, const string idNumber, const string driverLicense, const string expiryDate, const double creditPoints, const double renterRatingScore);
