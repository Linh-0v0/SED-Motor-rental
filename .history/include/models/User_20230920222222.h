...
public:
    ...
    string getIdNumber(const std::string &newIdNumber) const;
    string getDriverLicense(const std::string &newDriverLicense) const;
    string getExpiryDate(const std::string &newExpiryDate) const;
