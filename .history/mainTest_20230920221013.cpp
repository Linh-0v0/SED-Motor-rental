        ...
        if (USER_ROLE == 1)
        {
            ...
            while (1)
            {
                ...
                else if (command == 3 || command == 4)
                {
                    ...
                    int idType=0, BIKE_AVAILABLE=10;
                    double creditPoints=20,renterRatingScore=0;
                    std::string driverLicense, password, fullName,expiryDate, idNumber, phoneNumber="1";
                    ...
                    while (CHECK1==0){
                        ...
                        while (phoneNumber=="1"){
                            ...
                            cin >> phoneNumber;
                            if (strspn( phoneNumber.c_str(), "0123456789" ) == phoneNumber.size()){ID=1;}else{phoneNumber="1";cout << "Invalid input. Please try again\n";};
                        }
                        ...
                        while (ID==0){
                            cout << "Enter your ID:\n";
                            cin >> idNumber;
                            if (strspn( idNumber.c_str(), "-.0123456789" ) == idNumber.size()){ID=1;}else{ID=0;cout << "Invalid input. Please try again\n";};
                        ...
                        while (driverLicense==""){
                            ...
                            cin >> driverLicense;
                            if (strspn( driverLicense.c_str(), "-.0123456789" ) == driverLicense.size()){ID=1;}else{ID=0;cout << "Invalid input. Please try again\n";};
                        }
                    ...
                    userSystem.addUser(userSystem.registerUser(username, fullName, password, phoneNumber, idType, idNumber, driverLicense, expiryDate, creditPoints, renterRatingScore));
