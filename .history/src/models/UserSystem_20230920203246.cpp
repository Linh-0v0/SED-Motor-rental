...
{   std::string USERS_NAME;
    int CHECK1=0;
    stringstream stream;
    int ID_TYPE=0, BIKE_AVAILABLE=10, PHONE_NUMBER=1, DOLLAR;
    double CREDIT=20,renterRatingScore=0;
    std::string DRIVER_LICENSE, PASSWORD, FULL_NAME,EXP_DATE, IDx;
    string str,str1;
    double ID=0;
    ...
    User user(USERS_NAME, FULL_NAME, PASSWORD, PHONE_NUMBER, ID_TYPE, IDx, DRIVER_LICENSE, EXP_DATE, CREDIT, renterRatingScore);
