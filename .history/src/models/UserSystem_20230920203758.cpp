...
{   std::string username;
    int CHECK1=0;
    stringstream stream;
    int ID_TYPE=0, BIKE_AVAILABLE=10, phonenumber=1;
    double creditpoint=20,renterRatingScore=0;
    std::string DRIVER_LICENSE, password, fullname,EXP_DATE, IDx;
    string str,str1;
    double ID=0;
    ...
    User user(username, fullname, password, str, ID_TYPE, str1, DRIVER_LICENSE, EXP_DATE, creditpoint, renterRatingScore);
