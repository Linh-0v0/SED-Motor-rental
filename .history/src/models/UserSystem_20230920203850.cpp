...
{   std::string username;
    ...
    std::string DRIVER_LICENSE, password, fullname,EXP_DATE, idnumber;
    string str,str1;
    double ID=0;
    ...
    User user(username, fullname, password, str, idtype, str1, DRIVER_LICENSE, EXP_DATE, creditpoint, renterRatingScore);
