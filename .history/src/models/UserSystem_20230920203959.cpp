...
{   std::string username;
    ...
    std::string driverLicense, password, fullname,EXP_DATE, idnumber;
    string str,str1;
    double ID=0;
    ...
    User user(username, fullname, password, str, idtype, str1, driverLicense, EXP_DATE, creditpoint, renterRatingScore);
