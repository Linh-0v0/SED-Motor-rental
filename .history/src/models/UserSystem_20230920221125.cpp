...
/***** Others *****/
User registerUser(const string &username, const string fullName, const string password, const string phoneNumber, const int idType, const string idNumber, const string driverLicense, const string expiryDate, const double creditPoints, const double renterRatingScore)Ơ
