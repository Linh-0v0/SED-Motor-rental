...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername();
