...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getPassword()<<","<< user.get()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername();
...
/***** Others *****/
User registerUser(const string &username, const string CfullName, const string password, const string phoneNumber, const int idType, const string idNumber, const string driverLicense, const string expiryDate, const double creditPoints, const double renterRatingScore){
