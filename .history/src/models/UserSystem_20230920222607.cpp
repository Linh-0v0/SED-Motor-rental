...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getPassword()<<","<< user.getPhoneNumber()<<","<< user.get()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername();
