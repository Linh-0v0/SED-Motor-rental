...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getPassword()<<","<< user.getPhoneNumber()<<","<< user.getIdType()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername();
