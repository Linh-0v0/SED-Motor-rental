...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getPassword()<<","<< user.getPhoneNumber()<<","<< user.getIdType()<<","<< user.getIdNumber()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername();
