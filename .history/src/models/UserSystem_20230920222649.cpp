...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getPassword()<<","<< user.getPhoneNumber()<<","<< user.getIdType()<<","<< user.getIdNumber()<<","<< user.getD()<<","<< user.getUsername()<<","<< user.getUsername()<<","<< user.getUsername();
