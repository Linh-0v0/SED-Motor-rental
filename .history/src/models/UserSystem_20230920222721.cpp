...
{   
    ...
    outfile << "\n"<< user.getUsername()<<","<< user.getFullName()<<","<< user.getPassword()<<","<< user.getPhoneNumber()<<","<< user.getIdType()<<","<< user.getIdNumber()<<","<< user.getDriverLicense()<<","<< user.getExpiryDate()<<","<< user.getCreditPoints()<<","<< user.getR();
